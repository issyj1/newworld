/*
 * © 2025 Isabelle Johnson. All rights reserved.
 * This source code is licensed under the terms of the XYZ License.
 */
  ...
  window.addEventListener('scroll', () => {
    parallaxSections.forEach(section => {
      ...
      if (
        ...
        containerTop > -section.offsetHeight
      ) {
        img.style.transform =
          `translateY(${containerTop * -0.2}px)`;
      }
    });
  });
}
